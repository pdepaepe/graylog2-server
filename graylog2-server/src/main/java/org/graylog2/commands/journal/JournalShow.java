...
public class JournalShow extends AbstractJournalCommand {
    ...
    protected void runCommand() {
        ...
        sb.append("Graylog message journal in directory: ").append(kafkaJournalConfiguration.getMessageJournalDir().toAbsolutePath().toString()).append(
                "\n");
    ...
    private void appendSegmentDetails(KafkaJournal journal, StringBuffer sb) {
        ...
        for (LogSegment segment : segments) {
            ...
            sb.append("\t\t\t").append("Created at: ").append(new DateTime(segment.time().milliseconds(), DateTimeZone.UTC)).append("\n");
