...
const EmptyDashboardInfo = () => (
  <StyledJumbotron>
    ...
    <ul>
      ...
      <IfDashboard>
        <li><p>4. <b>Share</b> the dashboard with your colleagues with <a href="https://docs.ovh.com/fr/logs-data-platform/roles/" target="_blank" rel="noopener noreferrer">LDP roles</a>.</p></li>
      </IfDashboard>
    </ul>
    <p>
